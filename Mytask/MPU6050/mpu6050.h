...
#define MPU6050_RA_SMPLRT_DIV       0x19      //[0-7]陀螺仪采样率分频寄存器
...
#define MPU6050_RA_ACCEL_XOUT_H     0x3B    // 存储最近的X轴、Y轴、Z轴加速度感应器的测量值 */
#define MPU6050_RA_ACCEL_XOUT_L     0x3C
#define MPU6050_RA_ACCEL_YOUT_H     0x3D
#define MPU6050_RA_ACCEL_YOUT_L     0x3E
#define MPU6050_RA_ACCEL_ZOUT_H     0x3F
#define MPU6050_RA_ACCEL_ZOUT_L     0x40
#define MPU6050_RA_TEMP_OUT_H       0x41    // 存储的最近温度传感器的测量值 */
#define MPU6050_RA_TEMP_OUT_L       0x42
#define MPU6050_RA_GYRO_XOUT_H      0x43    // 存储最近的X轴、Y轴、Z轴陀螺仪感应器的测量值 */
...
uint8_t MPU_Get_Gyroscope(void);       //得到陀螺仪值(原始值)
void MPU6050_setSleepEnabled(uint8_t enabled);
uint8_t MPU_Get_Accelerometer(void);  //获取加速度原始值
uint8_t Get_shock_mpu6050(void);  //检测震动数据
#endif
